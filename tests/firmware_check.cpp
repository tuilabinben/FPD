...
// data length of 8 (end code + one word), end code 0000, then the word.
...
int main() {
  ...
  printf("\n=== G. PLC link: MC protocol 3E ASCII frames ===\n");
  ...
  { String f = plcFrameReadWords("M*", 0, false, 1);
    ...
    long declared = plcParseHex(f, 14, 4);
  ...
  plcReply("D00000FF03FF0000042401");
